/*
 * Public Domain as per http://robobunny.com/wp/2011/08/13/android-seekbar-preference/
...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
	...
	protected View onCreateView(ViewGroup parent){
		...
		try {
			...
			mLayout = (RelativeLayout)mInflater.inflate(R.layout.seek_bar_preference, parent, false);
		}
		catch(Exception e)
		{
	...
	public void onBindView(View view) {
		...
		if(!this.mLayout.isEnabled() && this.mLayout != null){
